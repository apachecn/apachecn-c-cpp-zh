...
![](Images/54ce6577-8405-4849-a5bb-40c6235b6d5b.png)
...
![](Images/4d305c80-4368-4efd-945c-8a4debac7d23.png)
...
![](Images/583fb0b1-7b58-4bab-ac2a-41fa81b5a685.png)
...
![](Images/835d6935-4712-4ccb-9e5c-8ff335816245.png)
...
![](Images/ff7076af-b140-497a-9d23-c4453a43415f.png)

13.  然后，我们再次运行相同的程序。这次还是`10`分区但是`1,000,000`样本。很明显，当我们从直方图中提取更多样本时，直方图看起来更加清晰*。这是一个重要的观察:*

 *![](Images/8178317e-d792-4766-be8a-d4e0e6a06d3c.png)
...
![](Images/5ba7d1ee-ef21-4b2d-ae4f-6d68d5bc6ab5.png)

14.  对每个分布的`1,000,000`样本进行的另一次运行显示，对于每个分布，直方图显得更加清晰和典型。但是我们也看到了哪些是慢的，哪些是快的，而它们是在生成的:

![](Images/0297daeb-5434-4bf4-8aa6-7f23b5036413.png)
