...
![](assets/b69bc634-2911-40d0-9411-e81b3669ca1d.png)
...
![](assets/8b43e8bc-dfb5-4646-af8c-bdac68791dc7.png)

按下任意键后，应用程序将继续并绘制几个改变位置的窗口：

![](assets/5c09380d-ac52-4546-8bc8-1ecae6e8a71d.png)
...
![](assets/3a140d03-40d0-49ff-b28a-52b8de8d1450.png)
...
![](assets/92ecf1c6-62c1-43d9-8655-d447e784184c.png)
...
![](assets/aba441bc-2074-4277-81e5-98b24f7cedcb.png)

最后，状态栏显示窗口的底部，并显示图像中坐标的像素值和位置：

![](assets/51ef8c4f-74dc-461b-b9d3-fcce324f3879.png)

我们可以使用状态栏以覆盖的方式显示消息。 可以更改状态栏消息的函数是`displayStatusBar`。此函数与覆盖函数具有相同的参数：窗口名称、要显示的文本以及显示它的时间段：

![](assets/73993491-a939-45ba-b3c1-0d0751c71782.png)
...
![](assets/639c9969-7c38-46c6-ac73-e9d1f88776b1.png)
...
现在，我们已经准备好在窗口中使用 OpenGL 进行绘制，但是我们需要像典型的 OpenGL 应用程序一样设置一个绘制 OpenGL 回调。 OpenCV 提供了`setOpenGLDrawCallback`函数，该函数有两个参数-窗口名称和回调函数：
...
![](assets/b91c5f48-2dd1-4d2d-a3a2-2174123b7983.png)
