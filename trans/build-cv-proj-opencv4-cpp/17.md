...
![](assets/23073665-c46c-439c-b6ea-e3717cd51ac7.png)
...
本章已经向您展示了创建实时人脸识别应用程序所需的所有步骤，并且只需使用基本算法，就可以进行足够的预处理，以允许训练集条件和测试集条件之间存在一些差异。 我们使用人脸检测来找出人脸在相机图像中的位置，然后进行几种形式的人脸预处理，以减少不同光照条件、相机和人脸方向以及面部表情的影响。
