...
![](assets/a9d63859-8852-406f-8c0e-3474395f5d97.png)

在*步骤 3* 中，我们想要检查`unique_ptr`与原始指针相比是否增加了任何内存。好消息是`unique_ptr`的大小和原始指针版本一样。该步骤的输出如下:

![](assets/541b1ef5-331f-4f88-b69d-1e6006d78c37.png)
...
![](assets/a75c73de-d7b4-4ff1-9412-af044422965d.png)
...
![](assets/2bbb9914-5677-489e-adc5-d9acef0e9550.png)
...
![](assets/d2ddef14-28cf-4cc5-9991-e6f703144054.png)
...
![](assets/04bbe152-7fff-49a6-a27f-fc23edc804d7.png)
...
![](assets/b4a4ef22-fc72-4027-89d9-435480e7b79c.png)
