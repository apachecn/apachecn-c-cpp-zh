...
![Introducing the C++ standard template library](../images/00015.jpeg)
...
![Downloading Boost libraries](../images/00016.jpeg)
...
![Deploying Boost libraries](../images/00017.jpeg)
...
打开记事本++应用程序，输入前面的代码，并将其保存为`C:\CPP`中的`lexical.cpp`—我们在[第 1 章](1.html#page "Chapter 1. Simplifying Your Network Programming in C++")、*中创建的目录，用 C++简化您的网络编程*。现在打开命令提示符，将活动目录指向`C:\CPP`，然后键入以下命令:
...
![Building Boost libraries](../images/00020.jpeg)
