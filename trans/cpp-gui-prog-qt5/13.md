...
![](Images/43e54681-0742-4983-9a4e-70c933538d25.png)

当您创建一个 Qt 快速应用程序项目时，Qt 创建者会要求您为您的项目选择最低要求的 Qt 版本:

![](Images/3077a542-a06f-4c6a-96d6-2b84826ebc78.png)
...
![](Images/fc36ad7d-787e-4a09-bde7-f95ab7c362df.png)
...
![](Images/d2c87dda-ef9d-45f7-89c1-0bc053484c75.png)
...
![](Images/cfbfa37c-2ba3-4e65-b456-4735c5c90efa.png)
...
![](Images/87221c3c-f5cb-4409-a1aa-2e1b86f76030.png)
...
![](Images/64d47d41-00c4-45c9-9bbe-80aff6dc8bd3.png)
...
![](Images/a20022be-e9e5-4630-baa7-4c0b82b689c5.png)
...
![](Images/ee431b85-661f-47d1-9709-8f4d7a64297b.png)
...
![](Images/931898a3-240c-472c-91f7-58409ec5cbc9.png)
...
![](Images/f61ed1c4-6c26-438d-a9d0-adfe3d663049.png)

创建项目后，我们需要向项目中添加一些图像文件，以便以后使用:

![](Images/984d0ff3-798c-46fe-9d4c-5b9745e3590c.png)
...
![](Images/44cb6357-0d0f-4a8c-83c4-c8182c2cafbb.png)
...
![](Images/885c2157-4e28-477d-8ccd-ebc2c3e669ec.png)
...
![](Images/4b63ff3b-64b7-4cf3-919d-de2c5407db44.png)

接下来，我们将矩形的颜色设置为`#fcf9f4`，边框颜色设置为`#efedeb`，然后将边框值设置为`1`。到目前为止，用户界面如下所示:

![](Images/2046715a-edfc-44b7-bd96-490ea0da78b6.png)
...
![](Images/d5578076-0799-402b-a013-554a56330e25.png)
...
![](Images/b17e64f5-faef-47a9-abd5-88669f766d47.png)
...
![](Images/882dcceb-99d9-4358-9e59-a444ab53d9d3.png)
...
![](Images/e4f5430c-1afb-4481-842b-fa0dcb61ffea.png)

如果您没有看到图像，并且收到错误消息说 Qt 无法打开图像，请回到您的`MainForm.ui.qml`并在源属性的前面添加前缀`image/`。这是因为 Qt 快速设计器加载的图像没有前缀，而您的最终程序需要前缀。添加前缀后，您可能会意识到您不再看到图像显示在 Qt 快速设计器上，但它将在您的最终程序中正常工作。
