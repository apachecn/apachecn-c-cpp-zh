...
请注意，与 LGPLv3 许可下提供的大多数 Qt 模块不同，Qt Chart 模块是在 GPLv3 许可下提供的。与 LGPLv3 不同，GPLv3 许可证要求您发布应用程序的源代码，而您的应用程序也必须在 GPLv3 获得许可。这意味着您不允许将 Qt 图表与您的应用程序静态链接。它还防止该模块用于专有软件。
...
![](Images/4e4f032b-86fb-4548-a497-f60076f9a6d3.png)
...
![](Images/9ef83d89-2839-43c4-9537-cb34557dddec.png)
...
![](Images/ca8c434b-348e-442c-83fc-d763be3e71c3.png)
...
![](Images/a5355056-5e99-4777-804c-117005d6848d.png)
...
由于上一个登录页面并没有考虑堆叠的小部件，我们必须对它进行一些调整。首先，将堆叠小部件从小部件框拖放到应用程序的中央小部件，然后，我们需要将中央小部件下的所有内容移动到堆叠小部件的第一页，我们将其重命名为 loginPage:

![](Images/4e44e2d8-9594-4cea-88c6-970b2e7fb0b7.png)

接下来，将中心小部件的所有布局设置设置为`0`，使其完全不包含边距，如下所示:

![](Images/4870550e-3423-44cc-9e59-782f31959dd6.png)
...
![](Images/8c047da2-209c-4102-94c5-ac0e8ec76c60.png)

接下来，将网格布局拖放到仪表板页面，并将“垂直布局”应用到仪表板页面:

![](Images/ed2ed650-4139-46e9-99f8-f2375414f6f1.png)

之后，将六个垂直布局拖放到网格布局中，如下所示:

![](Images/cc848c1e-1aa3-4a26-a6e1-966834507a66.png)

然后，选择我们刚刚添加到网格布局中的每个垂直布局，并将其转换为 QFrame:

![](Images/d5761610-be0c-4854-a859-603a27326ffc.png)
...
![](Images/2a440a24-0d6a-4d47-b54b-a50aee5eaffc.png)
...
![](Images/531baa65-d083-4a70-a57c-aeff6def670a.png)
