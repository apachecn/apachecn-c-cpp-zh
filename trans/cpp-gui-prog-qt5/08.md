...
您可以使用它来创建视频会议应用程序、安全摄像头系统等。我们开始吧！
...
![](Images/653beee6-57b1-4705-8987-5387abe142b4.png)
...
![](Images/c6d70bb6-30f2-426f-815c-a92e80f674e0.png)
...
我们使用`qApp->applicationDirPath()`获取应用程序目录，这样图像将与可执行文件一起保存。您可以将其更改为您想要的任何目录。您也可以将所需的文件名放在目录路径后面；否则，它将使用以`IMG_00000001.jpg`、`IMG_00000002.jpg`等开头的默认文件名格式依次保存图像。
