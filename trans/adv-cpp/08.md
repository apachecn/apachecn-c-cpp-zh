...
6.  Run the `a.out` binary file by typing the following command in the compiler:
    ...
    ![Figure 7.1: Running the Assertion binary on the Command Prompt](image/C14583_07_01.jpg)
...
7.  Now, inside the `main` function, we will pass `ip` with a length greater than `16` and check if the `assert` is called here too. Write the following code to implement this:
    ...
    ![Figure 7.2: Running the Assertion binary on the Command Prompt](image/C14583_07_02.jpg)
...
8.  Now, to satisfy the `assert` condition so that the binary runs fine, we need to update the value of `ip` inside the `main` function. Write the following code to do this:
    ...
    ![Figure 7.3: Running the Assertion binary on the Command Prompt](image/C14583_07_03.jpg)
...
2.  Create another header file named **PersonLibrary_ver2.h** and add the following code:
    ...
    ![Figure 7.5: Library file with a different version](image/C14583_07_05.jpg)
...
5.  Compile our **.cpp** file using the following command in the terminal:
    ...
    ![Figure 7.6: Seeing a static error](image/C14583_07_06.jpg)
...
![Figure 7.7: Static assertion compilation file](image/C14583_07_07.jpg)
...
5.  Open the terminal, compile our file, and run the binary. You will see the following output:
    ...
    ![Figure 7.8: Example execute code with exception handling](image/C14583_07_08.jpg)
...
7.  Open the terminal, compile our file, and run the binary. You will see the following output:
    ...
    ![Figure 7.9: Another example of exception handling](image/C14583_07_09.jpg)
...
![Figure 7.10: The binary runs fine without throwing an exception](image/C14583_07_10.jpg)
...
7.  Now, run the binary with the following command:
    ...
    ![Figure 7.11: Compiling and executing test cases](image/C14583_07_11.jpg)
...
![Figure 7.12: Output of test cases run](image/C14583_07_12.jpg)
...
9.  Now, write the following command to run the executable:
    ...
    ![Figure 7.13: Running the app](image/C14583_07_13.jpg)
...
![Figure 7.14: Running the Gmock test](image/C14583_07_14.jpg)
...
![Figure 7.15: Main function using the Stack class](image/C14583_07_15.jpg)
...
![Figure 7.16: Debugger display – I](image/C14583_07_16.jpg)
...
![Figure 7.20: Debugger display – IV](image/C14583_07_20.jpg)
...
![Figure 7.21: Debugger display – IV](image/C14583_07_21.jpg)
...
![Figure 7.23: All tests running properly](image/C14583_07_23.jpg)

###### 图 7.23:所有测试运行正常

以下是后续步骤的截图:

![Figure 7.24: All tests running properly](image/C14583_07_24.jpg)
