...
![Figure 5.1: The abstraction of the concurrency - a few people working on the same computer ](image/C14583_05_01.jpg)
...
![Figure 5.3: Synchronous execution in a single thread ](image/C14583_05_03.jpg)

###### 图 5.3:单线程中的同步执行

这里，每个任务都等待前一个任务完成。任务也可以在多个线程中同步执行。考虑下图，它表示在多个线程中同步执行四个任务。同样，每个任务都等待前一个任务完成:

![](image/C14583_05_04.jpg)
...
![Figure 5.5: Asynchronous execution in multiple threads ](image/C14583_05_05.jpg)
...
![Figure 5.6: The result of an example execution ](image/C14583_05_06.jpg)
...
![Figure 5.8: Two threads increment the same shared variable ](image/C14583_05_08.jpg)
...
5.  Run this code in your editor. You will see that the `divide()` function works correctly in `thr1`. The output looks as follows:
    ...
    ![Figure 5.9: The result of the correct exercise execution ](image/C14583_05_09.jpg)
...
![Figure 5.10: The result of the exercise’s execution with race conditions ](image/C14583_05_10.jpg)
...
![Figure 5.11: RAW data dependency between two threads   ](image/C14583_05_11.jpg)
...
![Figure 5.12: WAR data dependency between two threads ](image/C14583_05_12.jpg)
...
![Figure 5.13: WAW data dependency between two threads ](image/C14583_05_13.jpg)
...
![Figure 5.14: Two threads increment the same shared variable in a synchronized way ](image/C14583_05_14.jpg)
...
![Figure 5.15: Event synchronization of two threads ](image/C14583_05_15.jpg)
...
![Figure 5.18: The result of the exercise’s execution ](image/C14583_05_18.jpg)
...
![Figure 5.19: The result of an example’s execution ](image/C14583_05_19.jpg)
...
![Figure 5.20: The result of the example’s execution ](image/C14583_05_20.jpg)
...
![Figure 5.22: The result of this example’s execution ](image/C14583_05_22.jpg)
...
![Figure 5.23: The result of this exercise’s execution ](image/C14583_05_23.jpg)
...
![Figure 5.24: Description of the classes that are used in this activity ](image/C14583_05_24.jpg)

###### 图 5.24:本活动中使用的类的描述

让我们在开始实现之前创建类图。下图显示了上述所有具有关系的类:

![Figure 5.25: The class diagram ](image/C14583_05_25.jpg)
...
![Figure 5.26: The result of the application’s execution ](image/C14583_05_26.jpg)
...
接下来，我们研究了开发多线程应用程序时面临的不同问题，例如数据危险、竞争条件和死锁。了解这些问题有助于我们为项目构建一个清晰的同步架构。我们在一些实际例子中考虑了同步概念，这让我们很好地理解了在编写线程应用程序时可能面临的挑战。
