...
![Figure 4.1: Physical Dependencies of Matrix3d and Point3d ](image/C14583_04_01.jpg)
...
![Figure 4.2: Sample Pimpl implementation output ](image/C14583_04_02.jpg)
...
![Figure 4.3: Failed compilation of Pimpl using unique_ptr ](image/C14583_04_03.jpg)
...
![Figure 4.4: Sample unique_ptr Pimpl implementation output ](image/C14583_04_04.jpg)
...
4.  Click on the **Run** button. Exercise 1 will run and produce the following output:
    ...
    ![Figure 4.5: Exercise 1 Program output ](image/C14583_04_05.jpg)
...
![Figure 4.6: The Kitchen program output using Pimpl ](image/C14583_04_06.jpg)
...
![Figure 4.7: Function Pointer Program output ](image/C14583_04_07.jpg)
...
![Figure 4.8: Errors compiling function pointer program ](image/C14583_04_08.jpg)
...
![Figure 4.9: Function pointer program using static member function ](image/C14583_04_09.jpg)
...
![Figure 4.10: Functors program output ](image/C14583_04_10.jpg)
...
![Figure 4.11: Program output showing Scaler transformed vectors ](image/C14583_04_11.jpg)
...
4.  Click on the **Run** button. Exercise 2 will run and produce the following output:
    ...
    ![Figure 4.12: Exercise 2 Initial output ](image/C14583_04_12.jpg)
...
7.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![Figure 4.13: Exercise 2 Improved output format ](image/C14583_04_13.jpg)
...
![Figure 4.14: Exercise 2 output with average ](image/C14583_04_14.jpg)
...
![Figure 4.15: Structure of a std::function declaration ](image/C14583_04_15.jpg)
...
![Figure 4.16: Program output using std::bind() and std::function ](image/C14583_04_16.jpg)
...
4.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![Figure 4.17: Exercise 3 output (Calling empty std::function) ](image/C14583_04_17.jpg)
...
6.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![Figure 4.18: Exercise 3 output (preventing call to empty std::function) ](image/C14583_04_18.jpg)
...
9.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![Figure 4.19: Exercise 3 output (FreeMethod) ](image/C14583_04_19.jpg)
...
12.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![4.20: Exercise 3 output (Object function call override) ](image/C14583_04_20.jpg)
...
14.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![Figure 4.21: Exercise 3 output (Member function) ](image/C14583_04_21.jpg)
...
![Figure 4.22: Exercise 3 output (lambda function) ](image/C14583_04_22.jpg)
...
![Figure 4.23: Most common forms of lambda expressions ](image/C14583_04_23.jpg)
...
![Figure 4.24: Transform using lambda for scaling ](image/C14583_04_24.jpg)
...
![Figure 4.25: Another form of lambda expression ](image/C14583_04_25.jpg)
...
4.  Click on the **Run** button. The exercise will run and produce the following output:
    ...
    ![Figure 4.26: Initial output from Exercise 4 ](image/C14583_04_26.jpg)
...
7.  Examine the lambda, we have captured the local variable `sep` by reference. Remove the `&` from `sep` and click on the **Run** button. This time the compilation fails with the following error:
    ...
    ![Figure 4.27: Compilation failure due to modifying read-only variable ](image/C14583_04_27.jpg)
...
13.  Click on the **Run** button and the output now adds the list of values sorted in descending order:
    ...
    ![Figure 4.28: Program output for descending sort lambda ](image/C14583_04_28.jpg)
...
14.  Change the lambda function body to be `{return a<b;}`. Click on the **Run** button and the output now shows the values sorted in ascending order:
    ...
    ![Figure 4.29: Program output for ascending sort lambda ](image/C14583_04_29.jpg)
...
16.  Click on the **Run** button and the output now reports the number of `values > 25`:
    ...
    ![Figure 4.30: Output for count_if lambda stored in variable ](image/C14583_04_30.jpg)
...
17.  Add the following lines after the ones above and click the **Run** button:
    ...
    ![Figure 4.31: Erroneous output by re-using the pred lambda ](image/C14583_04_31.jpg)
...
![Figure 4.32: Correct output re-using the pred lambda ](image/C14583_04_32.jpg)
...
![Figure 4.33: Variadic Template Program Output ](image/C14583_04_33.jpg)
...
![Figure 4.34: Output from the successful implementation of Delegate ](image/C14583_04_34.jpg)
