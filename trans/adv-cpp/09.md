...
![Figure 8.2: C++ compiler ](image/C14583_08_02.jpg)

###### 图 8.2: C++编译器

完成后，左侧窗格的代码会自动重新编译，并且会生成汇编代码并显示在右侧窗格中。这里，输出是彩色编码的，以显示哪些汇编代码行是从哪些 C++代码行生成的。下面的屏幕截图显示了生成的程序集代码:

![Figure 8.3: Assembly result ](image/C14583_08_03.jpg)
...
![Figure 8.4: Assembly code of the sum function ](image/C14583_08_04.jpg)
...
![Figure 8.5: Assembly code of the for loop ](image/C14583_08_05.jpg)
...
![Figure 8.6: Assembly code of the next instruction ](image/C14583_08_06.jpg)
...
![Figure 8.7: Assembly code of the for loop ](image/C14583_08_07.jpg)
...
![Figure 8.8: Adding a compiler flag for optimization ](image/C14583_08_08.jpg)
...
![Figure 8.9: Assembly code with the new compiler ](image/C14583_08_09.jpg)

###### 图 8.9:使用新编译器的汇编代码

在前面的装配清单中，注意没有以`J`开始的指令(用于跳转)。因此，根本没有循环构造！让我们来看看编译器是如何计算`1`到`n`的和的。如果`n`的值为`< = 0`，则跳至 **.LBB0_1** 标签退出，返回`0`。让我们分析以下说明:

![Figure 8.10: Assembly code with the new compiler ](image/C14583_08_10.jpg)
...
![Figure 8.11: Assembly code generated with the new compiler ](image/C14583_08_11.jpg)
...
4.  Compile, run, and time this program on a Linux Terminal using the following commands:
    ...
    ![Figure 8.12: Output of timing the Snippet1.cpp code ](image/C14583_08_12.jpg)
...
5.  Use the following commands to explore the effect of using compiler optimization flags:
    ...
    ![Figure 8.13: Output of timing the Snippet1.cpp code compiled with -O3 ](image/C14583_08_13.jpg)
...
7.  Recompile and time again using the following commands:
    ...
    ![Figure 8.14: Output of timing the Snippet1.cpp code with 10,000 iterations ](image/C14583_08_14.jpg)
...
8.  Open the Compiler Explorer and paste in the entire code. Set the compiler options to `-O3` and observe the generated code:
    ...
    ![Figure 8.15: Snippet1.cpp code in Compiler Explorer ](image/C14583_08_15.jpg)
...
![Figure 8.16: Output of timing the Snippet1.cpp code with a side effect of printing the value ](image/C14583_08_16.jpg)
...
10.  Save the program and open a terminal. Compile and run the program with different optimization levels – on the `gcc` and `clang` compilers, this is specified by the `-ON` compiler flag, where `N` is a number from `1` to `3`. Add the `-O1` compiler flag first:
    ...
    ![Figure 8.17: Snippet2.cpp code performance when compiled with the -O1 option  ](image/C14583_08_17.jpg)
...
11.  Now, add the `-O2` compiler flag in the terminal and execute the program:
    ...
    ![Figure 8.18: Snippet2.cpp code performance when compiled with the -O2 option  ](image/C14583_08_18.jpg)
...
12.  Add the `-O3` compiler flag in the terminal and execute the program:
    ...
    ![Figure 8.19: Snippet2.cpp code performance when compiled with the -O3 option  ](image/C14583_08_19.jpg)
...
![Figure 8.20: Snippet2.cpp code output when using a macro for timing ](image/C14583_08_20.jpg)
...
3.  Now, use the following command to visualize the recorded data:
    ...
    ![Figure 8.22: Using the perf command to analyze the code in Snippet2.cpp ](image/C14583_08_22.jpg)
...
![Figure 8.23: Viewing the timing statistics using the perf command for the Snippet2.cpp code ](image/C14583_08_23.jpg)
...
3.  Save the program and open the terminal. Compile the program with the `-O3` flag first and time it using the following command:
    ...
    ![Figure 8.24: Output of the code in Snippet3.cpp ](image/C14583_08_24.jpg)
...
4.  Now, compile the same code with the loop unrolling enabled and time it again:
    ...
    ![Figure 8.25: Output of the code in Snippet3.cpp compiled with the loop unrolling option  ](image/C14583_08_25.jpg)
...
6.  On the right-hand side, select `x86-64 gcc 8.3` from the compiler options and write the `-O3` flag in the options. Assembly code will be generated. For the for loop, you'll see the following output:
    ...
    ![Figure 8.26: Assembly code of the for loop ](image/C14583_08_26.jpg)
...
![Figure 8.27: Assembly code of the for loop ](image/C14583_08_27.jpg)
...
![Figure 8.28: Timing results of the code in Snippet3.cpp with PGO optimization ](image/C14583_08_28.jpg)
...
3.  Save the program and open the terminal. Compile the program normally and time the execution using the following commands:
    ...
    ![Figure 8.29: Output of the code in Snippet4.cpp ](image/C14583_08_29.jpg)
...
![Figure 8.30: Output of the code in Snippet4.cpp compiled with parallelization options ](image/C14583_08_30.jpg)
...
![Figure 8.31: Output of the code in Snippet5.cpp showing the effect of vector::reserve() ](image/C14583_08_31.jpg)
...
![Figure 8.32: Output of the code in Snippet6.cpp showing the effect of optimizing boolean conditions  ](image/C14583_08_32.jpg)
...
![Figure 8.33: Output of the code in Snippet7.cpp showing the effect  of branch prediction optimization ](image/C14583_08_33.jpg)
...
![Figure 8.34: Output of the code in Snippet8.cpp contrasting the timing  of std::list and std::vector insertion  ](image/C14583_08_34.jpg)
...
7.  Save the program and open the terminal. Compile and run the program by writing the following commands:
    ...
    ![Figure 8.35: Output of the code in Snippet9.cpp contrasting the timing  of computation versus random memory access ](image/C14583_08_35.jpg)
...
![Figure 8.36: Output of the code in Snippet10.cpp contrasting the timing  of computation versus random and linear memory access  ](image/C14583_08_36.jpg)
...
7.  Save the file and open the terminal. Compile and run the program:
    ...
    ![Figure 8.37: Output of the code in Snippet11.cpp showing the effect of heap allocation on the timing  ](image/C14583_08_37.jpg)
...
8.  Now, use the `perf` command to profile:
    ...
    ![Figure 8.38: Output of the perf command profiling the code in Snippet11.cpp  ](image/C14583_08_38.jpg)
...
![Figure 8.40: Output of the code in Snippet12.cpp contrasting the timing  of the AOS and SOA patterns  ](image/C14583_08_40.jpg)
...
3.  Let's compile, run, and get an idea of the performance. We will verify that it is working right by comparing the result of our code with the results provided by the standard `wc` program:
    ...
    ![Figure 8.41: Output of the code in Snippet13.cpp with a baseline wordcount implementation ](image/C14583_08_41.jpg)
    ...
    ![Figure 8.42: Output of timing the wc program  ](image/C14583_08_42.jpg)
...
5.  Compile and test the performance now:
    ...
    ![Figure 8.43: Output of the code in Snippet14.cpp ](image/C14583_08_43.jpg)
...
7.  Now, time the code we wrote:
    ...
    ![Figure 8.44: Output of the code in Snippet15.cpp ](image/C14583_08_44.jpg)
...
9.  Compile and time the execution of this version:
    ...
    ![Figure 8.45: Output of the code in Snippet16.cpp ](image/C14583_08_45.jpg)
...
11.  Compile and time the code:
    ...
    ![Figure 8.46: Output of the code in Snippet17.cpp ](image/C14583_08_46.jpg)
...
12.  Now that we have the code where the bulk of the work is done by a standard library function, we can now get automatic parallelization for free – compile and test as follows:
    ...
    ![Figure 8.47: Output of the code in Snippet17.cpp with the parallelized standard library ](image/C14583_08_47.jpg)
    ...
    ![Figure 8.48: Output of the code in Snippet16.cpp with the parallelized standard library ](image/C14583_08_48.jpg)
...
14.  Compile and run the program:
    ...
    ![Figure 8.49: Output of the code in Snippet18.cpp with simplified logic for detecting spaces ](image/C14583_08_49.jpg)
    ...
    ![Figure 8.50: Output of the code in Snippet18.cpp with the parallelized standard library ](image/C14583_08_50.jpg)
...
16.  Compile and run the preceding code:
    ...
    ![Figure 8.51: Output of the code in Snippet18.cpp with all operations timed ](image/C14583_08_51.jpg)
...
21.  Compile and time all three versions:
    ...
    ![Figure 8.52: Output of the code in Snippet19.cpp, which counts the beginnings  of words rather than the ends ](image/C14583_08_52.jpg)
    ...
    ![Figure 8.53: Output of the code in Snippet20.cpp  ](image/C14583_08_53.jpg)
    ...
    ![Figure 8.54: Output of the code in Snippet21.cpp  ](image/C14583_08_54.jpg)
...
23.  Compile and run this version:
    ...
    ![Figure 8.55: Output of the code with changed file load code in SnippetWC4.cpp  ](image/C14583_08_55.jpg)
...
![Figure 8.56: Output of the code in Snippet22.cpp that uses SIMD intrinsics ](image/C14583_08_56.jpg)

###### 图 8.56:snippet 22 . CPP 中使用 SIMD 内函数的代码输出

请注意，我们需要使用`-march=native`标志，以便编译器使用 AVX SIMD 指令集。如果处理器不支持它，将导致编译错误。如果此可执行文件是为 AVX 目标编译的，并且在处理器不支持这些指令的系统上运行，程序会因“非法指令”异常而崩溃。这似乎是一个非常小的改进，但并不显著——用汇编程序或 SIMD 优化所需的努力和学习曲线通常太高，除非您的应用程序或行业有这些要求，否则是不合理的。SIMD 版本一次处理 32 个字节，但性能几乎没有提高。事实上，如果您使用编译器资源管理器检查其他代码片段中常规 C++实现的生成的汇编代码，您将看到编译器本身已经使用了 SIMD——这正好说明了编译器在让您的代码变快方面走了多远。
...
![Figure 8.57: Example output of the code for Step 1 ](image/C14583_08_57.jpg)

###### 图 8.57:步骤 1 的代码输出示例

以下是步骤 2 的输出:

![Figure 8.58: Example output of the code for Step 2 ](image/C14583_08_58.jpg)

###### 图 8.58:步骤 2 的代码输出示例

以下是步骤 3 的输出:

![Figure 8.59: Example output of the code for Step 3 ](image/C14583_08_59.jpg)
...
在这些章节的最后，您已经探索了许多与使用高级 C++相关的主题。在前几章中，您已经学习了如何编写可移植的软件，如何使用模板来使用类型系统，以及如何有效地使用指针和继承。然后，您已经探索了 C++标准库，包括流和并发，它们是构建大型现实世界应用程序的基本工具。在最后几节中，您学习了如何测试和调试程序，以及如何优化代码以高效运行。在广泛使用的编程语言中，C++可能是最复杂的，也是最具表现力的。这本书只是一个开始，它会给你一个坚实的平台来继续你的进一步学习。