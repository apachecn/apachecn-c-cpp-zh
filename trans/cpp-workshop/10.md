...
![Figure 10.1: Single inheritance diagram ](image/C14195_10_01.jpg)
...
![Figure 10.2: Compilation error since MyBaseClass is declared final ](image/C14195_10_02.jpg)
...
![Figure 10.3: Accessing the area member defined in the base Shape class ](image/C14195_10_03.jpg)
...
![Figure 10.4: Multiple inheritance diagram ](image/C14195_10_04.jpg)
...
![Figure 10.5: Diamond problem ](image/C14195_10_05.jpg)
...
![Figure 10.6: Properties accessed in scope ](image/C14195_10_06.jpg)
...
![Figure 10.7: Accessing members from both base classes ](image/C14195_10_07.jpg)
...
![Figure 10.8: Access modifier combinations ](image/C14195_10_08.jpg)
...
4.  Let's run this application and see what our compiler gives us:
    ...
    ![Figure 10.9: Errors to the accessibility of the members ](image/C14195_10_09.jpg)
...
![Figure 10.10: The output from our overridden virtual function ](image/C14195_10_10.jpg)
...
![Figure 10.11: The functionality of both implementations ](image/C14195_10_11.jpg)
...
![Figure 10.12: Trying to instantiate an abstract class ](image/C14195_10_12.jpg)
...
![Figure 10.13: We overrode CalculateArea, specializing that function in each derived class ](image/C14195_10_13.jpg)
...
![Figure 10.14: We've called two different implementations of a function from the same object type ](image/C14195_10_14.jpg)
...
![Figure 10.15: Using polymorphism, we've stored our derived types as pointers to their base ](image/C14195_10_15.jpg)
...
在这个例子中，我们有从`MyClassA`继承的`MyClassB`。我们实例化`MyClassB`，将其存储在指向`MyClassA`的指针中，然后尝试访问两者的成员。如果我们运行这个应用程序，我们会得到什么？

![Figure 10.16: We're unable to access the members declared in the derived class from the base ](image/C14195_10_16.jpg)
...
![Figure 10.17: We're unable to downcast from MyClassA to MyClassB since it's not a polymorphic type ](image/C14195_10_17.jpg)
...
![Figure 10.18: Casting to our derived type allows us to call members specific to them ](image/C14195_10_18.jpg)
...
![Figure 10.19: Users can view information on various animals ](image/C14195_10_19.jpg)
