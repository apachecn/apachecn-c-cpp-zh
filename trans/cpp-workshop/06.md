...
6.  Compile and run the program and observe the result, which looks something like this:
    ...
    ![Figure 6.1: Output of the program in exercise 37 ](image/C14195_06_01.jpg)
...
![Figure 6.2: Output of the revised program of exercise 37 ](image/C14195_06_02.jpg)
...
![Figure 6.3: Output of the program for exercise 38 ](image/C14195_06_03.jpg)
...
![Figure 6.4: Output of the program in exercise 39 ](image/C14195_06_04.jpg)
...
![Figure 6.5: Creating and deleting dynamic arrays of classes ](image/C14195_06_05.jpg)
...
4.  Compile and run the program. If you are using an online compiler, use a compiler that displays the output from the operating system, such as Coliru; cpp.sh does not. The output of the program is an error message (depending on the operating system):
    ...
    ![Figure 6.6: Error message resulting from running the program in exercise  41 ](image/C14195_06_06.jpg)
...
7.  Compile and run the program. Its output on one particular compiler and operating system is as follows:
    ...
    ![Figure 6.7: Output of the program in exercise 42 ](image/C14195_06_07.jpg)
...
6.  Compile and run the program. The output is as you expected. It looks like this:
    ...
    ![Figure 6.8: Output of the program in exercise 43 ](image/C14195_06_08.jpg)
...
![Figure 6.9: Output of the program in exericse 44 ](image/C14195_06_09.jpg)
...
![Figure 6.10: Error output of the program in exercise 45 ](image/C14195_06_10.jpg)
...
![Figure 6.11: Error message when deleting a dynamic array with delete instead of delete[] ](image/C14195_06_11.jpg)
...
![Figure 6.12: Error message when deleting a dynamic variable with delete instead of delete[] ](image/C14195_06_12.jpg)
...
![Figure 6.13: Visualizing linked lists ](image/C14195_06_13.jpg)
...
![Figure 6.14: A binary search tree growing upside down ](image/C14195_06_14.jpg)
...
![Figure 6.15: Adding items to a linked list ](image/C14195_06_15.jpg)
...
16.  Compile and run the program. Its output should look like this:
    ...
    ![Figure 6.16: Output of the first version of the program in exercise 48 ](image/C14195_06_16.jpg)
...
![Figure 6.17: Output of the program in exercise 48 ](image/C14195_06_17.jpg)
