...
![Figure 4.1: Observing our simple arithmetic operators ](image/C14195_04_01.jpg)
...
![Figure 4.2: The modulo operator ](image/C14195_04_02.jpg)
...
![Figure 4.3: Determining whether a number is a prime ](image/C14195_04_03.jpg)
...
![Figure 4.4: We can test the equality of two values or objects by using relational operators ](image/C14195_04_04.jpg)
...
![Figure 4.5: Using relational comparison operators to determine the relationship between values ](image/C14195_04_05.jpg)
...
![Figure 4.6: Using relational operators, we can determine what time of day it is ](image/C14195_04_06.jpg)
...
如果我们在代码编辑器中运行这个应用程序，我们可以看到这些运算符对我们的价值的影响:

![Figure 4.7: Using the minus operator to change sign ](image/C14195_04_07.jpg)
...
![Figure 4.8: Using increment or decrement to modify a value ](image/C14195_04_08.jpg)
...
我们刚刚看到，可以对一个值进行前增量或后增量，它们各自在操作方式上有细微但明显的区别。让我们通过编写一个同时做这两者的应用程序来看一个例子。你能猜出输出吗？看看下面的步骤:
...
![Figure 4.9: Pre-increment versus post-increment gives us different results ](image/C14195_04_09.jpg)
...
![Figure 4.10: Combining the simple assignment operator with arithmetic operators ](image/C14195_04_10.jpg)
...
7.  运行应用程序，并用几个不同的名称测试它:

![Figure 4.11: Using logical operators to test conditions ](image/C14195_04_11.jpg)
...
![Figure 4.12: Overloading an operator with our own behavior ](image/C14195_04_12.jpg)
...
![Figure 4.13: Person A and B were a match. Person B and C were not ](image/C14195_04_13.jpg)
...
![Figure 4.14: We can see the results of our bitwise operations by using the bitset class ](image/C14195_04_14.jpg)
...
![Figure 4.15: The Fizz Buzz application – a common coding test exercise ](image/C14195_04_15.jpg)

图 4.15:Fizz Buzz 应用程序——一个常见的编码测试练习
