...
5.  Run the complete code in your editor. You will see that it evaluates the statements and outputs the correct string, as shown in the following screenshot:
    ...
    ![Figure 2.1: The if/else statement allows us to execute certain code based on conditions ](image/C14195_02_01.jpg)
...
![Figure 2.2: We can make menu selections and output the correct information ](image/C14195_02_02.jpg)
...
![Figure 2.3: The code works the same, but this time presented as a switch statement ](image/C14195_02_03.jpg)
...
![Figure 2.4: A while loop flowchart ](image/C14195_02_04.jpg)
...
![Figure 2.5: The application now loops and is able to process multiple user inputs ](image/C14195_02_05.jpg)
...
![Figure 2.6: Diagram of a do while loop ](image/C14195_02_06.jpg)
...
1.  Insert the following code, which includes a `while` loop only, in the compiler window, and then execute it:
    ...
    ![Figure 2.7: Output when using the while loop ](image/C14195_02_07.jpg)
...
![Figure 2.8: A do while loop showing that the body is executed at least once ](image/C14195_02_08.jpg)
...
![Figure 2.9: A for loop diagram  ](image/C14195_02_09.jpg)
...
![Figure 2.10: Output of the for loop ](image/C14195_02_10.jpg)
...
8.  Run the application. When complete, the application should be able to generate the specified number of random integers, as shown here:
    ...
    ![Figure 2.11: Program that will run indefinitely, outputting a series of numbers if the user doesn't quit ](image/C14195_02_11.jpg)
...
![Figure 2.12: Example counting application will print out numbers 0-4 ](image/C14195_02_12.jpg)
...
![Figure 2.13: With the break statement in place, we only execute 2 loop iterations ](image/C14195_02_13.jpg)
...
![Figure 2.14: All loops give the same outcome: two iterations before exiting ](image/C14195_02_13.jpg)
...
![Figure 2.15: The printing of number 3 has been skipped ](image/C14195_02_15.jpg)
...
![Figure 2.16: We use break and continue to control loop execution ](image/C14195_02_16.jpg)
...
![Figure 2.17: Number-guessing game output ](image/C14195_02_17.jpg)
