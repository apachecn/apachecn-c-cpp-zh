...
11.  Compile and run the program. Its output is as follows, along with a description of what you are seeing:
    ...
    ![Figure 7.1: Output of the program in exercise 49 with corresponding description ](image/C14195_07_01.jpg)
...
10.  Compile and run the program. Its output is reproduced here:
    ...
    ![Figure 7.2: Output of the program in exercise 50 ](image/C14195_07_02.jpg)
...
![Figure 7.3: Output of the program in exercise 51 ](image/C14195_07_03.jpg)
...
16.  Compile and run the completed program. Its output looks as shown below. Of course, different runs of the program may print out different hexadecimal pointer addresses:
    ...
    ![Figure 7.4: Outyput of the program in exercise 52 ](image/C14195_07_04.jpg)
...
![Figure 7.5: Output of the program in exercise 53 ](image/C14195_07_05.jpg)
...
10.  Compile and run the program. Its output is reproduced here:
    ...
    ![Figure 7.6: Output of the program in exercise 54 ](image/C14195_07_06.jpg)
...
7.  The output of this program is reproduced here. A single instance of `noisy` is created inside `func()`, transferred to `u1`, and then deleted when `main()` returns, signaling the successful transfer of ownership:
    ...
    ![Figure 7.7: Output of the program in exercise 55 ](image/C14195_07_07.jpg)
...
![Figure 7.8: Simplified memory layout of shared_ptr ](image/C14195_07_08.jpg)
...
12.  Compile and execute the program on a C++ compiler that supports C++17\. Online compilers supporting C++17 include **Coliru** and **Tutorialspoint**. Unfortunately, cpp.sh is only a C++14 compiler and will not compile this code. The output looks like this:
    ...
    ![Figure 7.9: Output of the program in exercise 56  ](image/C14195_07_09.jpg)
...
![Figure 7.10: Simplified memory layout of a dynamic object and reference count after make_shared() ](image/C14195_07_10.jpg)
...
9.  Compile and run the completed program. Its output looks like this:
    ...
    ![Figure 7.11: Output of program in exercise 56 ](image/C14195_07_11.jpg)
