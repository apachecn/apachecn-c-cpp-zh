...
![Figure 8.1: Output of the code ](image/C14195_08_01.jpg)
...
![Figure 8.2: Output reflecting the value from the constructor ](image/C14195_08_02.jpg)
...
![Figure 8.3: Track name and length output ](image/C14195_08_03.jpg)
...
![Figure 8.4: Output from the compiler-generated copy constructor ](image/C14195_08_04.jpg)
...
![Figure 8.5: Shallow copy ](image/C14195_08_05.jpg)
...
![Figure 8.6: Updated track data for a given artist using the SetData function  ](image/C14195_08_06.jpg)
...
![Figure 8.7: Output in the case when an object is passed by value  ](image/C14195_08_07.jpg)
...
![Figure 8.8: Output when using the copy constructor  ](image/C14195_08_08.jpg)
...
![Figure 8.9: Output when overloading the assignment operator ](image/C14195_08_09.jpg)
...
8.  Now that we have a working assignment operator, we can test it using the same example as the copy constructor. Run the code, and you will obtain the following output:
    ...
    ![Figure 8.10: Output for the overloaded assignment operator  ](image/C14195_08_10.jpg)
...
![Figure 8.11: A possible output from the VideoClip class ](image/C14195_08_11.jpg)
