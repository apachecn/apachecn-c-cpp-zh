...
在过去的章节中，我们已经看到了如何编写纯函数和 lambdas。这些是函数式编程的基本构件。是时候让他们更上一层楼了。
...
![](assets/332f1ee6-da2c-45e7-8605-58a475e6b52f.png)表示对于 *x* ，![](assets/fc102ff6-21a4-45e8-aa49-1b6bf0f9daf7.png)的每个值。

![](assets/14204b22-3e95-49e7-b99f-9726698eca8d.png)符号是函数合成的数学运算符。
...
让我们花点时间看看结果和我们的工作方法。好消息是——我们在学习如何在函数中思考方面取得了很大进步。我们前面的例子仅仅通过作为代码的第一级公民操作函数来工作，如果我们想要使用函数范式设计应用程序，这正是我们所需要的心态。函数的分解和重组非常强大；掌握它，你将能够用很少的代码实现非常复杂的行为。
