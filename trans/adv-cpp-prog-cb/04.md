...
![](assets/84d28ad2-c0bd-49a0-879d-ad42f5add912.png)
...
![](assets/395bc1d6-02a2-4609-be80-8855f53d6acc.png)
...
![](assets/3eadc479-fa00-4c25-9a68-b82cb13ee914.png)
...
![](assets/cb55d047-89b4-4e40-815a-273456762831.png)
...
![](assets/5ca6a189-e687-45a2-a8cd-422d3e2f274e.png)

在这个例子中，我们函数的`void`是由`std::enable_if`创建的。如果`T`不是整数，则不返回`void`，我们会看到这个错误(而不是代码编译并允许我们首先执行它):

![](assets/d7ec86d0-edec-409d-8dd5-76b3abfa3978.png)
...
![](assets/1c12f216-9fc9-4b34-9868-9ccf45ae4fb7.png)
...
![](assets/eb4f4cb0-e924-4b6e-af1a-617c8e3183b0.png)
...
![](assets/c64d9b68-b5d8-4ce2-ba02-17195ee8906d.png)
...
![](assets/6a2956d6-ac8c-4113-b411-eb131555a556.png)
...
![](assets/cf8bb6b4-07e7-4b3e-a97e-3a558cfc3533.png)

在前面的例子中，我们创建了`constexpr`并在编译时而不是运行时对其求值。如果我们将`constexpr`更改为实际变量，`constexpr if`将导致以下错误:

![](assets/9474112b-7528-4649-b754-1e6702247c6c.png)
...
![](assets/fac54cfd-01a0-4fc8-a4e1-80bb81c1fd5f.png)
...
![](assets/3e437b68-faa5-4a2b-a2e5-1353d8935542.png)
...
![](assets/d6d45daa-3d12-43cd-b947-93a9aa3990f1.png)
...
![](assets/0308a282-75f7-42fd-82e6-4debaf2bd0d2.png)
...
![](assets/e9bee1c2-cc4a-4a6b-8b40-d2f08e9c28b8.png)
...
![](assets/e5ae3433-362c-4d0d-a865-298472d67d5c.png)
...
![](assets/dee00755-5e4b-4fe9-8067-fe5306327929.png)
...
![](assets/08ad857b-3e01-41e9-885d-ceea78bc65f1.png)
...
![](assets/cdc10992-381a-45a6-80a6-aff500c8753f.png)
...
![](assets/b30b50ca-8f48-4791-80c2-83b5886b15f3.png)
