...
![](Images/eac5111d-7d6f-4570-873d-39a1ff71f770.png)
...
![](Images/252ea42c-9ddc-4a58-82d5-b93bd5f3776f.png)
...
![](Images/7a87f11b-b826-44c8-8f49-bb4b58ead3fd.png)

3.  双击组合框，将出现一个窗口，您可以在其中编辑组合框。我们将通过点击+按钮三次并将项目`PNG`、`JPEG`和`BMP`重命名来添加三个项目到组合框列表中:

![](Images/9e6f2092-3dd4-4c74-afbe-543af56e873b.png)

4.  右键单击其中一个按钮并选择转到插槽…，然后单击确定按钮。插槽功能将自动添加到您的源文件中。对另一个按钮也重复此步骤:

![](Images/e3a9460b-28b6-4037-a049-31edbdbb6d00.png)
...
![](Images/ac4c09fc-4f30-4d2d-b158-799edddcb2b3.png)
...
![](Images/be74039a-eabf-4e2a-9d05-412f0bbf8d9f.png)

4.  双击组合框，将出现一个窗口来编辑组合框。我们将通过单击+按钮三次向组合框列表中添加三个项目，并将项目`AVI`、`MP4`和`MOV`重命名为:

![](Images/9698e1ab-f94c-4f98-87dd-fd3e832cf910.png)
...
![](Images/afec0b79-b48c-4563-ab02-83dae201fd20.png)
...
![](Images/3f03cc7c-1440-4dfc-82f1-b95a9e183464.png)

5.  在顶部布局中添加两个标签，将左边的文本设置为`From**:**`，然后将右边的设置为`To:`。向第二个布局添加两个线编辑小部件，并将它们的默认值都设置为`1`:

![](Images/bf3cf63e-ab04-48fe-a2ff-5714e88cef00.png)

6.  选择右侧的行编辑，并启用属性窗格中的只读复选框:

![](Images/83ea3526-e37e-4270-bb96-28ef4374bff2.png)

7.  将光标属性设置为“禁止”，以便用户在小部件上鼠标悬停时知道它不可编辑:

![](Images/413cae05-af0c-42dc-89d2-ca1b005ad6ff.png)

8.  在底部的第三个布局中添加两个组合框。我们暂时将它们留空:

![](Images/1727edbe-c18f-481e-b3b8-1afd77cb9175.png)
...
![](Images/af3bffb0-df5f-4330-a6ac-199cb63c3e18.png)
