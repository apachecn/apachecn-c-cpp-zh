...
我们可以以任何形式存储 10 封电子邮件，这不会影响应用程序的性能。然而，很明显，随着时间的推移，电子邮件的数量将会增长。对于每个新收到的电子邮件，我们将一个带有相应字段的`Email`对象推入`inbox`数组。数组的最后一个元素代表最近收到的电子邮件。因此，为了显示最近十封电子邮件的列表，我们需要读取并返回数组的最后十个元素。
...
![](assets/f7318cbc-fefa-41f1-a377-9bf8ebd60b26.png)
...
![](assets/8f1961c0-dcd6-481f-8ae8-3ba43902ba49.png)
...
![](assets/11cb3eec-b2a8-4166-8fdf-a58cf516bf90.png)
...
![](assets/0f4021af-1ec3-4d9d-85ca-891a7e16e42a.png)
...
![](assets/de263cb6-41ed-4f47-a59e-1a9e01261f64.png)
...
![](assets/06be3736-adbe-4388-9396-677b0a094a7f.png)

*   在列表末尾插入一个元素如下图所示:

![](assets/6f88bf92-0a38-448d-a32c-8a92883f53ab.png)

*   最后，在列表中间插入一个元素的操作如下:

![](assets/75876dd0-13a8-4b23-a1be-68ac50c50dd0.png)
...
![](assets/5b07753c-2089-4701-a865-3e98d597197f.png)
...
![](assets/ffb6f27e-00ca-4b30-86b7-4cdfd6c1530e.png)
...
![](assets/62daaf10-d88c-4439-a8e8-4bb85feb15e4.png)
...
![](assets/62c34472-4720-43f8-80c1-71ac1b5ab204.png)
...
![](assets/080ab163-ffd0-4b7b-8ff8-2ba3e9dfed60.png)
...
![](assets/bff12ecb-958e-4b6b-95b1-d731f5a627a6.png)
...
![](assets/d94643e3-cbfa-4816-8059-4ac126c1bbcb.png)
...
![](assets/47e01350-abf8-4a83-8eba-70afe1301af7.png)
...
![](assets/04d19255-e43e-485b-af2f-6269d220bd0e.png)
...
![](assets/4a058f5f-c5de-47fb-94e4-a5e25dbf0440.png)
...
![](assets/2d7a6c25-7b1f-4a4d-a3c1-80259c833393.png)
...
![](assets/89c34b2d-9597-4ea4-ac1a-a32ef5031eb7.png)
...
![](assets/c478e0fd-ae7e-4b99-8bec-7c288cd13272.png)
...
![](assets/303865f2-ae26-44a9-bce2-0f8cefb9cc6f.png)

该算法开始在未排序的子阵列中寻找最小的元素，并通过与未排序的子阵列的第一个元素进行交换将其放入排序的子阵列中。在每一步之后，排序的子阵列的长度增加一，而未排序的子阵列的长度减少，如下所示:

![](assets/995dc143-d05a-4a3d-b808-de3d058583c5.png)
...
![](assets/9c361b58-ff03-4ab1-bffc-dd29595f2378.png)
...
![](assets/5623724b-8217-4b70-8fac-b52b713d8435.png)
...
![](assets/92b32da1-8667-447b-b087-481c79ac0dc4.png)

另一方面，图表示没有适当顺序的连接节点:

![](assets/84949559-6f1a-41a6-8b34-746c60392218.png)

假设我们正在建立一个社交网络，最终将脸书挤出市场。社交网络中的用户可以相互跟随，这可以表示为图形。例如，如果 A 跟在 B 后面，B 跟在 C 后面，而 C 既跟在 B 后面又同时跟在 A 后面，那么我们可以将这些关系表示为下图:

![](assets/afd3b4ab-05ed-448a-8612-d596cce84d88.png)
...
![](assets/ff9a742f-9d83-4b1d-b655-77d3f57fe938.png)
...
![](assets/c99154de-7f04-4bfe-8ae5-b8ba7ed23ecb.png)
