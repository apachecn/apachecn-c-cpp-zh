...
![Figure 9.1: A solved Sudoku puzzle](image/C14498_09_01.jpg)
...
![Figure 9.2: All possible subsets for the given 0-1 knapsack problem](image/C14498_09_02.jpg)
...
![Figure 9.4: Getting the next values in Pascal’s triangle](image/C14498_09_04.jpg)
...
![Figure 9.5: Pascal’s triangle represented as an N × N DP table](image/C14498_09_05.jpg)
...
![Figure 9.6: Two-dimensional DP table constructed by the proposed algorithm](image/C14498_09_06.jpg)
...
![Figure 9.7: Subproblem results for each weight-index pair ](image/C14498_09_07.jpg)
...
![Figure 9.9: Activity 22 test case 1 ](image/C14498_09_09.jpg)

###### 图 9.9:活动 22 测试用例 1

![Figure 9.10: Activity 22 test case 2 ](image/C14498_09_10.jpg)

###### 图 9.10:活动 22 测试用例 2

![Figure 9.11: Activity 22 test case 3 ](image/C14498_09_11.jpg)

###### 图 9.11:活动 22 测试用例 3

![Figure 9.12: Activity 22 test case 4 ](image/C14498_09_12.jpg)
...
![Figure 9.13: Visualizing the Bellman-Ford algorithm](image/C14498_09_13.jpg)
...
![Figure 9.14: Bellman-Ford Step 1](image/C14498_09_14.jpg)

###### 图 9.14:行李员-福特第一步

![Figure 9.15: Bellman-Ford Step 2](image/C14498_09_15.jpg)

###### 图 9.15:行李员-福特步骤 2

![Figure 9.16: Bellman-Ford Step 3](image/C14498_09_16.jpg)
...
![Figure 9.17: All the states for the shortest-path problem ](image/C14498_09_17.jpg)
...
![Figure 9.18: Activity 23, test cases 1 (left) and 2 (right) ](image/C14498_09_18.jpg)

###### 图 9.18:活动 23，测试用例 1(左)和 2(右)

让我们考虑上图右侧的示例输出。在那个例子中，从`E(0,4)`到`C(5,4)`的路径不能被建造为不可逾越的障碍，`#`存在。让我们考虑一些更复杂的示例:

![Figure 9.19: Activity 23, test cases 3 (left) and 4 (right) ](image/C14498_09_19.jpg)

###### 图 9.19:活动 23，测试用例 3(左)和 4(右)

请注意，不同的符号用于表示不同类型的障碍物。尽管任何障碍的影响都是一样的，但我们不能在那里修路。最后，让我们在下面的示例中增加复杂性:

![Figure 9.20: Activity 23, test case 5 ](image/C14498_09_20.jpg)
