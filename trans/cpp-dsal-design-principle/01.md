...
![](image/C14498_01_04.jpg)

###### 图 1.4:比较连续和链接数据结构的表格

下表包含有关各种参数的数组和链表的性能摘要:

![](image/C14498_01_05.jpg)
