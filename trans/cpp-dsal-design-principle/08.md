...
![Figure 8.1: Computing the nth term in the Fibonacci sequence](image/C14498_08_01.jpg)
...
![Figure 8.2: Computing the nth term in the Fibonacci sequence using cached solutions](image/C14498_08_02.jpg)
...
![Figure 8.3: Optimal substructure and overlapping subproblems ](image/C14498_08_03.jpg)
...
![Figure 8.4: Recursively calculating the Nth factorial](image/C14498_08_04.jpg)
...
![Figure 8.5: Eliminating values that exceed the target](image/C14498_08_05.jpg)
...
![Figure 8.6: Depiction of how the complexity of the subset sum problem’s recursive structure is reduced in the tabulated DP solution](image/C14498_08_06.jpg)
...
![Figure 8.7: Multiple paths with the same sum value on the same index value](image/C14498_08_07.jpg)
...
![Figure 8.8: Example of city adjacencies](image/C14498_08_08.jpg)
...
![Figure 8.9: Activity 18 simple test cases ](image/C14498_08_09.jpg)

###### 图 8.9:活动 18 简单测试用例

下面是一些更复杂的测试案例:

![Figure 8.10: Activity 18 complex test cases ](image/C14498_08_10.jpg)
...
![Figure 8.11: Diff utility output](image/C14498_08_11.jpg)
...
![Figure 8.12: Two given strings for finding the longest common subsequence](image/C14498_08_12.jpg)

###### 图 8.12:找到最长公共子序列的两个给定字符串

最长的公共子序列是“`LONGEST`”:

![Figure 8.13: Longest common subsequence in the given strings](image/C14498_08_13.jpg)
...
![Figure 8.14: All possible character subsequences of two strings, ABCX and ACY](image/C14498_08_14.jpg)
...
![Figure 8.15: Subproblem tree for the longest subsequence problem](image/C14498_08_15.jpg)
...
![Figure 8.16: Activity 19 test cases ](image/C14498_08_16.jpg)
...
![Figure 8.17: Memo table for ABCABDBEFBA and ABCBEFBE](image/C14498_08_17.jpg)
...
![Figure 8.18: Activity 20 test cases ](image/C14498_08_18.jpg)
...
![Figure 8.19: Musical notations](image/C14498_08_19.jpg)

###### 图 8.19:音乐符号

下图展示了以乐谱形式表示的不同音符之间的距离:

![Figure 8.20: Musical intervals](image/C14498_08_20.jpg)
...
![Figure 8.21: Enharmonically equivalent notes represented on a section of a piano](image/C14498_08_21.jpg)
