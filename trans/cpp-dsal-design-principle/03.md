...
![Figure 3.1: A simple hash table](image/C14498_03_01.jpg)
...
![Figure 3.2: Basic operations in a hash table](image/C14498_03_02.jpg)

###### 图 3.2:哈希表中的基本操作

![Figure 3.3: Basic operations in a hash table (continued)](image/C14498_03_03.jpg)
...
![Figure 3.4: Basic operations on a hash table with chaining](image/C14498_03_04.jpg)

###### 图 3.4:带链接的哈希表的基本操作

![Figure 3.5: Basic operations on a hash table with chaining (continued)](image/C14498_03_05.jpg)
...
![Figure 3.6: Load factor](image/C14498_03_06.jpg)
...
![Figure 3.7: Basic operations on a hash table with linear probing](image/C14498_03_07.jpg)

###### 图 3.7:带有线性探测的哈希表的基本操作

![Figure 3.8: Unable to insert elements after hash table fills up](image/C14498_03_08.jpg)
...
![Figure 3.9: Cuckoo hashing](image/C14498_03_09.jpg)

###### 图 3.9:布谷鸟散列

一个主要问题是，我们可能会陷入一个循环，递归可能会导致无限循环。对于上一段中的例子，考虑有一个元素 *D* ，我们希望在这里插入 *C* ，但是如果我们试图移动 *D* ，它会转到 *A* 的位置。因此，我们处在一个无限循环中。下图应该有助于您直观地看到这一点:

![Figure 3.10: A cycle formed during cuckoo hashing](image/C14498_03_10.jpg)
...
![Figure 3.11: Inserting elements in a hash table that uses cuckoo hashing](image/C14498_03_11.jpg)

###### 图 3.11:在使用布谷鸟哈希的哈希表中插入元素

![Figure 3.12: Handling collisions in a hash table using cuckoo hashing](image/C14498_03_12.jpg)

###### 图 3.12:使用布谷鸟哈希处理哈希表中的冲突

![Figure 3.13: Handling collisions in a hash table using cuckoo hashing (continued)](image/C14498_03_13.jpg)

###### 图 3.13:使用布谷鸟哈希处理哈希表中的冲突(续)

![Figure 3.14: Finding values in a hash table that uses cuckoo hashing](image/C14498_03_14.jpg)

###### 图 3.14:在使用布谷鸟哈希的哈希表中查找值

![Figure 3.15: Erasing values in a hash table that uses cuckoo hashing](image/C14498_03_15.jpg)
...
![Figure 3.16: Inserting elements in a bloom filter](image/C14498_03_16.jpg)

###### 图 3.16:在布隆过滤器中插入元素

![Figure 3.17: Finding elements in a bloom filter](image/C14498_03_17.jpg)

###### 图 3.17:在布隆过滤器中查找元素

![Figure 3.18: Finding elements in a bloom filter (continued)](image/C14498_03_18.jpg)
