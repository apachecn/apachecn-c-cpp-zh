...
| `GoldenEgg` | `2` | ![](assets/c3918bbc-1d30-4f56-aea2-4df86976f902.png) |
| `MetalDonut` | `1` | ![](assets/9b920363-321a-41c9-a215-8f472aad5bc9.png) |
| `Cow` | `2` | ![](assets/771da95a-5e07-4846-94f1-346279693904.png) |
...
![](assets/ead175d8-8699-48a9-88de-6c8fa1c2086b.png)
...
![](assets/d6b3e574-9bbc-455d-a1aa-44ad05f4822e.png)

2.  下载内容示例后，打开并点击
    创建项目:

![](assets/d191f3be-af11-46e1-b608-8255fd89edc7.png)
...
![](assets/c401500f-fb64-4339-ad53-cb369c27eed2.png)

Assets available in the project

5.  找到您喜欢的资产后，右键单击该资产，然后单击资产操作>迁移，将其导入到项目中...：

![](assets/aaf26cd5-cdb2-4f0c-9784-bd815f8f43c4.png)

6.  在资产报告对话框中单击确定:

![](assets/335e3f20-4f45-4d42-b3b0-2f87a74e648b.png)

7.  从项目中选择要添加 SM_Toy_Cow 文件的内容文件夹。我们将其添加到`/Documents/Unreal Projects/GoldenEgg/Content`，如下图截图所示:

![](assets/be9114fd-5243-4752-b5a0-eaa04fed5e27.png)

8.  如果导入成功完成，您将看到以下消息:

![](assets/fd127d7a-4618-45e8-9a57-66f9bca8328e.png)

9.  导入资产后，您将看到它显示在项目内部的资产浏览器中:

![](assets/2eea6f29-6e2e-4ef0-a5a5-7fc312a12e4e.png)
...
![](assets/6b70bffd-3536-4c2b-b521-1103b6ba0183.png)
...
![](assets/01cb7674-3e98-4a88-b927-5a8a3b556723.png)
...
![](assets/d5a2836e-5c31-47f8-8303-68ad756e0f6d.png)
...
![](assets/3283ccec-e589-4b8e-a8b9-140c368d86d8.png)
...
![](assets/d31e3ea5-d9e9-4708-b3a0-6e15ee9f845c.png)
...
![](assets/4fcda832-ff9a-491d-9c16-031a2ca91188.png)
