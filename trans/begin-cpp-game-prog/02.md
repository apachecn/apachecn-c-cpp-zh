...
![](image/B14278_02_2.jpg)

现在，对于赋值运算符：

![](image/B14278_02_3.jpg)
...
如果我们允许作出决定的话，我们可以做决定。在上一章中，我们已经看到了`if`在动作中，当我们检测到播放器是否在每一帧按下*Esc*键时：
