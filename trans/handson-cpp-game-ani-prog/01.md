...
1.  Open Visual Studio and create a new project by going to **File**|**New**|**Project**:
    ...
    ![Figure 1.1: Creating a new Visual Studio project ](Images/Figure_1.1_B16191.jpg)
...
2.  You will see your project templates on the left-hand side of the window that pops up. Navigate to **Installed**|**Visual C++**|**Other**. Then, select **Empty Project**:
    ...
    ![Figure 1.2: Creating an empty C++ project ](Images/Figure_1.2_B16191.jpg)

    图 1.2:创建一个空的 C++项目

3.  输入项目名称并选择项目位置。最后，点击**创建**。

![Figure 1.3: Specifying a new project name ](Images/Figure_1.3_B16191.jpg)
...
1.  Go to the site, select **Version 3.3** from the **gl** dropdown, and select **Core** from the **Profile** dropdown:
    ...
    ![Figure 1.4: Configuring glad ](Images/Figure_1.4_B16191.jpg)
...
![Figure 1.5: Stats counter for the AllChapters sample ](Images/Figure_1.5_B16191.jpg)
