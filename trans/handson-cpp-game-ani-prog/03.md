...
![Figure 3.1: Comparing row- and column-major matrices ](Images/Figure_3.1_B16191.jpg)

图 3.1:比较行和列主矩阵

大多数数学书籍和 OpenGL 都使用列主矩阵。在本章中，您还将实现列主矩阵。理解矩阵中的内容很重要。矩阵的对角线包含缩放信息，最后一列包含平移:

![Figure 3.2: What is stored in a matrix? ](Images/Figure_3.2_B16191.jpg)
...
![Figure 3.3: Matrix storage mapping to a linear array ](Images/Figure_3.3_B16191.jpg)
...
![Figure 3.4: Multiplying matrices ](Images/Figure_3.4_B16191.jpg)
...
![Figure 3.5: A 2 x 2 matrix and the formula for the determinant ](Images/Figure_3.5_B16191.jpg)
...
![Figure 3.6: The minor of element 2, 1 in a 3 x 3 matrix ](Images/Figure_3.6_B16191.jpg)
...
![Figure 3.7: A checkerboard pattern of -1 to the i + j power ](Images/Figure_3.7_B16191.jpg)
