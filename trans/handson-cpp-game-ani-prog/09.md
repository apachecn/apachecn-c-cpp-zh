...
![Figure 9.1: The dependencies of generating a pose.](Images/Figure_9.1_B16191.jpg)
...
![Figure 9.2: Multiple root nodes in one file](Images/Figure_9.2_B16191.jpg)
...
能够加载动画片段并将其采样成姿势大约是动画编程所涉及工作的一半。您可以加载动画剪辑，在应用程序更新时对其进行采样，并使用调试线来绘制姿势。结果是一个动画骨架。在下一章中，您将学习如何使用这个动画骨架来变形网格。
