...
![](assets/4420e4ca-d7cd-49f6-aec5-905e41fbb6ea.png)

这里，![](assets/a469f19b-0d40-4b4e-a9e0-6e5635065eb3.png)是预测数和地面真值项，![](assets/180f3214-140e-4164-b314-2be89f5c8e0d.png)是第*I*T4 项的地面真值，![](assets/3aa53062-98a2-4670-a6cf-29ff2efddeb3.png)是第*I*T9 项的预测值。
...
![](assets/2d2c1ae4-1312-4a70-8b96-2d33ecd3f7c4.png)
...
![](assets/44472237-2b71-49d7-86fa-a6fd5560597a.png)
...
![](assets/9a9820ab-b6f9-486f-a658-35e79b5608f5.png)

![](assets/65e526ec-460b-4705-920d-7f742101b4f2.png)

![](assets/cf5575e3-1dcf-4172-89f0-cd3b06bd511d.png)

这里，![](assets/17de253f-ae1a-4e5e-b71f-33c341ba0669.png)是预测数和地面真值项， <sub xmlns:epub="http://www.idpf.org/2007/ops">![](assets/c945ee36-a7df-4b56-807b-a48962ca85d5.png)</sub> 是 *i* <sup xmlns:epub="http://www.idpf.org/2007/ops">第</sup>项的地面真值，<sub xmlns:epub="http://www.idpf.org/2007/ops">![](assets/b86ebf79-3f67-4670-9d44-3687b7651bf0.png)T10】是 *i* 第<sup xmlns:epub="http://www.idpf.org/2007/ops">项的预测值。</sup></sub>
...
![](assets/43d3c1ee-e654-4419-838c-06e2d30ee2d6.png)
...
|  | <sub>![](assets/070e7ce2-8cbf-4e0e-abd9-fdce45364207.png)</sub> | <sub>![](assets/e2429a16-55ee-48d2-a048-bf74646ece08.png)</sub> |
| <sub>![](assets/99869422-43cf-49fc-b6da-0f8099cc29b9.png)</sub> | **真阳性** ( **TP** ) | **假**T2 阳性( **FP** |
| <sub>![](assets/5bd91440-4498-4e67-91f8-8cbb12d7e713.png)</sub> | **假** **负** (FN) | **真负** ( **TN** ) |

在这里， <sub xmlns:epub="http://www.idpf.org/2007/ops">![](assets/d4bd25eb-56ce-41ba-8ef6-e4fd29419a6c.png)</sub> 是预测类的对象而 <sub xmlns:epub="http://www.idpf.org/2007/ops">![](assets/6da28b97-bc64-43e3-a686-53fc2283b7ce.png)是地面真理的标签。混淆矩阵是我们用来计算不同分类度量的抽象。它给出了正确分类和错误分类的项目数量。它还为我们提供了关于错误分类类型的信息。假阴性是我们的算法错误地归类为阴性的项目，而假阳性是我们的算法错误地归类为阳性的项目。在本节中，我们将学习如何使用该矩阵并计算不同的分类性能指标。</sub>

# 准确(性)

最明显的分类指标之一是准确性:

![](assets/f39a5fb7-b24e-4388-afdc-63795f2f4c1c.png)
...
![](assets/b06764ce-e365-4c87-89d4-18c2eae38e45.png)

但是，如果算法预测所有的字母都是非垃圾邮件，那么它的准确性应该如下:

![](assets/f65fe321-aa2f-4077-a9e1-b9a6d7553aa1.png)
...
![](assets/d21ff915-4302-4871-becc-10ef6ce61c3c.png)

中心的圆包含*个选定的元素*–我们的算法预测为正的元素。

精度与所选项目中正确分类的项目数量成正比。精确度的另一个名称是*特异性*:

![](assets/1b071495-47ee-45f4-9841-a4de9f1bc3db.png)

回忆与所有地面真实阳性项目中正确分类项目的数量成正比。召回的另一个名称是*灵敏度*:

![](assets/3d7c8b62-d364-4973-a00c-9c07387b469b.png)
...
![](assets/cf49cdf8-be94-43cb-9bc6-e813e04a2301.png)

这里， <sub>![](assets/d54a8b03-0364-461c-959b-467d2f4bf7be.png)</sub> 是精确的公制重量。通常， <sub>![](assets/72086656-82bd-43e0-b05f-74ea6ce0b37a.png)</sub> 值等于 1。在这种情况下，我们有一个等于 *2* 的乘数值，如果*精度* = *1* 和*召回* = *1* 就给我们 <sub>![](assets/11357113-4852-49d8-9d72-ce630fae5607.png)</sub> 。在其他情况下，当精度值或召回值趋于零时，F-measure 值也会降低。
...
![](assets/cf262341-17c3-49aa-b4cd-55db0944e309.png)

![](assets/36f5eb5d-7709-4b6d-9ea0-223ce86bd3d4.png)
...
![](assets/ac040d53-8266-4358-bf05-6055054f9bba.png)
...
![](assets/24363515-6fa9-4f99-9106-c8f3ab5cb47c.png)
...
![](assets/b7f9ee37-cb49-4fba-93ef-aa55d4b0249d.png)
...
![](assets/f230f00a-f9b0-4c5c-8c70-51cb99100494.png)
...
![](assets/1bd19d70-721f-4f32-900f-786d34faad01.png)

在这个图中，我们可以看到多项式回归模型对于多项式次数的输出等于 8。输出值接近训练数据和验证数据。下图显示了培训过程中的 MAE 值:

![](assets/984060fb-7fd0-4562-8002-4e0a5979ec15.png)
...
![](assets/24fe759c-90af-4d6d-90ad-8fecede4c46d.png)
...
![](assets/b79f049f-46d4-4642-9aee-165513a718b2.png)
...
![](assets/48f2dc46-500c-4bcc-915f-4ff9ea9e326f.png)
