...
![](assets/8a524c84-989f-42ee-a3bb-07d3d95fa6ef.png)
...
![](assets/58d0adaf-31a8-45fa-85aa-2ef16b155019.png)
...
![](assets/13918915-c0b6-448b-b3be-996e683d26a9.png)
...
应用程序编译完成后，你应该可以使用箭头键在画布上移动飞船。现在我们有了一个基本的游戏循环，在下一部分，我们将在我们的应用程序中添加一些游戏对象，使它更像一个游戏。
...
![](assets/23123d7f-c321-4339-b623-e4be90bc4388.png)
