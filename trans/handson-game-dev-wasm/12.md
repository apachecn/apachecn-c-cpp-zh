...
在我们给我们的主游戏添加音效之前，我将向您展示如何在`audio.c`文件中制作音频播放器，以演示如何使用 **SDL 音频**在网络组装应用中播放音效。这个应用将采用五种音效，我们将在我们的游戏中使用，并允许用户按数字键 1 到 5 来播放所有选择的音效。我将首先向您展示分成两个部分的代码，然后我将向您介绍每件事的作用。以下是`audio.c`中除`main`功能外的所有代码:
