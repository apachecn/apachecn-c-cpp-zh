...
您需要安装一些应用和工具来开始开发网络组装。我们将使用 Visual Studio Code(一个文本编辑器)来编写我们的 C/C++、JavaScript、HTML 和 Wat。我们还将使用 Node.js 来提供文件，并使用 Git 来管理我们的代码。我们将使用包管理器来安装这些工具，这使得安装过程比手动下载和安装它们简单得多。在本节中，我们将介绍操作系统，以及每个平台的包管理器。我们还将回顾每个应用，简要概述它们在开发过程中的作用。
